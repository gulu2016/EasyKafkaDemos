 ...
 * @Package: main.java
 * @ClassName: Unit8.CustomerFileStreamSourceTask
 * @Description: java类作用描述
 * @Author: gulu
 * @CreateDate: 19-4-3 上午10:27
 * @UpdateUser: 更新者
 * @UpdateDate: 19-4-3 上午10:27
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class CustomerFileStreamSourceTask extends SourceTask {
                    ...
                    do{
                        ...
                        if(line != null){
                            ...
                            records.add(new SourceRecord(offsetKey(filename),offsetValue(streamOffset),
                                    topic,null,null,VALUE_SCHEMA,line));
                        }
                    }while (line != null);
                }
            }
    ...
    private Map<String,Long> offsetValue(Long streamOffset) {
        return Collections.singletonMap(POSITION_FIELD,streamOffset);
    }
